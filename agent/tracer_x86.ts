...
const api = getApi();
// comment layout 
//  "----->"  means, added during experimentations to remove overheads related to log() function calls.
...
export function trace_x86(userTraceCallbacks_: TraceCallbacks, classRegex_: RegExp = /.*/, methodRegex_: RegExp = /.*/) {
    methodRegex = methodRegex_;
    classRegex = classRegex_;
    userTraceCallbacks = userTraceCallbacks_;
    Java.perform(() => {
        log("trace() starting up to see if the deoptimisation is correctly done in other antivirus apps");
        //test_client();
        //send_log("first bloc");
...
function makeMethodEntered(): NativePointer {
    ...
    Interceptor.attach(callback, {
        onEnter: function (args) {
            ...
            //log(result_info);
            //result_info = "\n" + result_info + "\n" + " testing method name : " + stringMethodName + " regex : " + methodRegex; 
            //log(result_info);
            ...
            //result_info = "\n" + result_info + " testing class name " + className + " regex " + classRegex;
            //log(result_info);
            ...
            if(  !( classRegex.test(className) || methodRegex.test(stringMethodName as string)) ){
                return; // continue execytion if class match or method match. 
            }
            ...
            //result_info =  result_info +  "\n" + "Interface Method obtained" + interfaceMethod;
            ...
            //result_info =  result_info +  "\n" + "prototype_string_address : " + prototype_string_address_old;
            ...
            if(shorty.length == 1){
                ...
                for(let i = 0; i < size; i++) {
                    ...
                    result_info =  result_info +  "\n" + "parameter" + i + "type in string " + descriptor_string;
            ...
            do { 
                ...
                try{
                    if(i > 13){ /*IN THIS CASE, WE ARE SURE THAT WE ARE NO LONGER IN THE INTERPRETER CASE AS EXPLAINED ABOVE, BUT WE ARE 
                              ...
                              */
                        code_compiled = true; 
                        result_info =  result_info +  "\n" + "Probably we are with a compiled source code";
                        break;
                    }
                    ...
                    if(prospective_method.equals(this.method)){
                        ...
                        //result_info =  result_info +  "\n" + "Shadow frame code_item = " + prospective_shadow_frame_code_item;
                        ...
                        //result_info =  result_info +  "\n" + "number of registers = " + number_registers + " number of inputs " + number_inputs;
                        if(number_inputs <= number_registers){
                            //log(" //////////////start/////////////");
                            //log("Method: " + prospective_method);
                            result_info =  result_info +  "\n" + "Shadow frame :" + prospective_shadowFrame + " thread position " + i;
                            result_info =  result_info +  "\n" + "thread : " + thread;
                            ...
                            //result_info =  result_info +  "\n" + "number of vreg " + shadow_frame_number_vregs;
                            ...
                            //result_info =  result_info +  "\n" + "Result register  = " + result_register;
                            ...
                            //result_info =  result_info +  "\n" + "stay in interpreter = " + stay_in_interpreter;
                        }
                        break;
                    }else{
                        continue;
                    ...
                    //log(result_info + "Odile_Error -------->" + error);
                }
            } while(++i < matchList.length);

            /// NOW PROCESSING THE CASE WHERE THE CODE IS COMPILED
            if(code_compiled){
                i = 0; result_info =  result_info +  "\n" + "---------------->The method code is probably compiled";
                do { 
                    let thread_stack_pointer: NativePointer = matchList[i].address;
                    try{
                       // IN THIS CASE, WE ARE SURE THAT WE ARE NO LONGER IN THE INTERPRETER CASE AS EXPLAINED ABOVE, BUT WE ARE 
                        ...
                        //result_info =  result_info +  "\n" + "-----> compiled code";
                        //result_info =  result_info +  "\n" + "Prospective object : " + prospective_object;
                        //result_info =  result_info +  "\n" + "Object : " + this.object;
                        //result_info =  result_info +  "\n" + "Prospective method: " + prospective_method + ", method: "+method;
                        result_info =  result_info +  "\n" + "-->this.method: " + this.method
                         + " ---->prospective method: " + prospective_method + "thread stack pointer: " + thread_stack_pointer;
            ...
            result_info =  result_info +  "\n" + "Call to doSomething took " + (end - start) + " milliseconds.";
            log(result_info);
